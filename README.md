...
|deploykit-backend|0.2.6|0.2.5|Possible downgrade from the current version (0.2.6   0.2.5)|
...
|pcsx2|1.6.0<br>+git20210825|1.7.5870|Compound version number '1.6.0+git20210825'<br>Version number indicates a snapshot (+git) is used|
|pdfgrep|2.1.2|2.2.0|
...
|sunshine|0.23.0|2024.607.215756|
